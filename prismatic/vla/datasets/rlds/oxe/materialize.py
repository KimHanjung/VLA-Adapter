...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.JOINT_POS_BIMANUAL, ActionEncoding.EEF_LATENT]:
    ...
    elif dataset_kwargs["action_encoding"] is ActionEncoding.EEF_LATENT: # NOTE: Assume that latent_dim == 64
        dataset_kwargs["absolute_action_mask"] = [False] * 64
        dataset_kwargs["action_normalization_mask"] = [True] * 64
